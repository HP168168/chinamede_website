...
export const pageSchema: Record<string, any[]> = {
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "您可以通过以下方式预约免费试听：拨打全国统一服务热线400-800-4459；扫码添加课程顾问微信；或直接到访就近校区。课程顾问会为您安排1节正课试听，并输出《个人学习规划书》。"
          }
        }
      ]
    }
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "可拨打全国统一服务热线400-800-4459（每天8:00-23:00）、扫码添加课程顾问微信，或直接到访就近校区。课程顾问会安排1节正课试听，并输出《个人学习规划书》。"
          }
        }
      ]
    }
  ...
  "/articles/": [
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.chinamede.com/articles/#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
    ...
    {
      "@type": "CollectionPage",
      "@id": "https://www.chinamede.com/articles/#webpage",
      "url": "https://www.chinamede.com/articles/",
      "name": "精选文章_行业洞察_岗位解析_学习路径 - 美迪时代教育",
      "description": "美迪时代教育精选文章：AI新媒体、视觉设计、短视频、短剧、跨境电商等行业洞察与岗位解析，包含关键数据、常见问题与官方引用来源，帮助你快速判断职业方向。",
      "isPartOf": {
        "@id": "https://www.chinamede.com/#website"
      },
      "about": {
